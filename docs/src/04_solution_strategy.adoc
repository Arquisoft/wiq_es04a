...
* Other programming languages can be used to experiment
...
We are going to divide tasks for each person placing the deadline at the middle of the maximum established time by the delivery.
Then other person will review the work done.
