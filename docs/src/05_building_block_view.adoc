...
First decomposition of the system. It shows the webapp, users managament and quetion generator modules as blackboxes. Also displays the docs module which contains the documentation of the project.
