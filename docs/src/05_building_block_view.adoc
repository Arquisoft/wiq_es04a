...
* **User Service**: Handles the registration and login of users.
...
Decomposition of the level 1 system. It shows the mongoDB module.
...
Decomposition of the level 1 system. It shows the mariaDB module.
