            ...
            {error? (
                ...
                <Box>
                    <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                        <Button onClick={() => setSelectedMode('The Challenge')} variant="contained" sx={{ marginRight: '10px', backgroundColor: selectedMode === 'The Challenge' ? 'white' : theme.palette.primary.main, color: selectedMode === 'The Challenge' ? theme.palette.primary.main : 'white', borderColor: theme.palette.primary.main, '&:hover': { backgroundColor: theme.palette.secondary.main, color: theme.palette.primary.main, borderColor: theme.palette.primary.main } }}>The Challenge</Button>
                        <Button onClick={() => setSelectedMode('Wise Men Stack')} variant="contained" sx={{ marginRight: '10px', backgroundColor: selectedMode === 'Wise Men Stack' ? 'white' : theme.palette.primary.main, color: selectedMode === 'Wise Men Stack' ? theme.palette.primary.main : 'white', borderColor: theme.palette.primary.main, '&:hover': { backgroundColor: theme.palette.secondary.main, color: theme.palette.primary.main, borderColor: theme.palette.primary.main } }}>Wise Men Stack</Button>
                        <Button onClick={() => setSelectedMode('Warm Question')} variant="contained" sx={{ marginRight: '10px', backgroundColor: selectedMode === 'Warm Question' ? 'white' : theme.palette.primary.main, color: selectedMode === 'Warm Question' ? theme.palette.primary.main : 'white', borderColor: theme.palette.primary.main, '&:hover': { backgroundColor: theme.palette.secondary.main, color: theme.palette.primary.main, borderColor: theme.palette.primary.main } }}>Warm Question</Button>
                        <Button onClick={() => setSelectedMode('Discovering Cities')} variant="contained" sx={{ backgroundColor: selectedMode === 'Discovering Cities' ? 'white' : theme.palette.primary.main, color: selectedMode === 'Discovering Cities' ? theme.palette.primary.main : 'white', borderColor: theme.palette.primary.main, '&:hover': { backgroundColor: theme.palette.secondary.main, color: theme.palette.primary.main, borderColor: theme.palette.primary.main }  }}>Discovering Cities</Button>
                    </div>
                    {renderStatistics()}
                </Box>
            )}
