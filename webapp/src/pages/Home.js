        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, flexWrap: 'nowrap', alignItems: { xs: 'center' }, margin: 'auto 3em', gap: '3em' }} >
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2em' }}>
                ...
                <Typography variant="body1" align="center">
                    Welcome to WIQ, also known as Wikidata Infinite Quest. On this page, a vast array of challenges awaits you, which will help you become the most knowledgeable person in the world. <br/>
                    To achieve this, you'll need to complete various mini-games. But don't worry, thanks to our dynamic question system, you can play as many times as you want since the questions are infinite.<br/>
