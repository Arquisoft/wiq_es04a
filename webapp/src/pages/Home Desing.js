...
const Home = () => {
    ...
    return (
        <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: 'center', flex:'1', marginX:'10%'}}>
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center",justifyContent: 'center', width:'40%', marginRight:'5%'}}>
                <img src={"./FondoR.png"} alt="Foto del minijuego" style={{ maxWidth:'100%' ,border: "2px solid #006699", borderRadius: "5px"}}/>
            </Box>
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center",justifyContent: 'center', width:'40%', marginLeft:'5%'}}>
